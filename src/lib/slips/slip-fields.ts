...
export const SLIP_FIELDS: Record<string, SlipFieldDef[]> = {
  ...
  T5: [
    ...
    { key: 'box15', label: 'Box 15 — Foreign Income', valueType: 'number', required: false },
    { key: 'box16', label: 'Box 16 — Foreign Tax Paid', valueType: 'number', required: false },
  ...
  T4RSP: [
    { key: 'issuerName', label: 'Financial Institution Name', valueType: 'text', required: true },
    { key: 'box20', label: 'Box 20 — Total RRSP Income (Amount Withdrawn)', valueType: 'number', required: true },
    { key: 'box22', label: 'Box 22 — Income Tax Deducted', valueType: 'number', required: false },
  ],
  T4RIF: [
    { key: 'issuerName', label: 'Financial Institution Name', valueType: 'text', required: true },
...
export const SLIP_PRIMARY_BOX: Record<string, { key: string; label: string }> = {
  ...
  T4RSP: { key: 'box20', label: 'RRSP withdrawal' },
